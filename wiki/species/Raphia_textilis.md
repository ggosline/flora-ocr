---
type: species
name: Raphia textilis
authority: Welw. Figure 4C,D
genus: Raphia
family: Arecaceae
vol: 53
pages: 64-65
...
atut (fang) ; dinimba (bavarama, bavungu, béséki. éshira) ; dinyimba (bapunu) ; dipiku (msangu) ; diramba (balumbe, ngowé) ; enimba (ivéa) ; épéko (mitsogo) ; inimba (galoa, mpon gwè, nkomi, orungu) ; laposos (bakèlè) ; lénimba (banzabi) ; lipigi (mindumu) ; lipigu (bavili) ; lipiku (baduma) ; mbaya (batéké) ; mposo (bakota) ; ndimba (benga) ; péko (apindji, bavové, simba) ; pigi (ambamba). Usage : Les fibres des jeunes feuilles utilisées pour faire des vêtements et des sacs
