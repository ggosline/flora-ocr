...
herbe à Nicot, tabac (fr.) ; tobacco (angl.) ; akaya (atégé, batéké) ; ditalako (okandè) ; évóló (baduma) ; gévóló (bavové) ; givóló (bavili) ; ivóló (banzabi) ; italako (ngowé) ; léka (am bèdè) ; likaya, ovóló (mindumu) ; ndakwè (bakota) ; ndalaka (bawumpfu) ; sôngá (loango) ; tabako (bapunu, benga) ; taga (fang) ; tako (apindji, galoa, mitsogo, mpongwè, nkomi, orungu) ; takulu (éshira) ; talako (ivéa, shakè) ; talaku (bavarama, éshira) ; talakwé (bakèlè, béséki) ; tarakwè (baléngi) ; tsunga (balumbu, bapunu, bavungu)
