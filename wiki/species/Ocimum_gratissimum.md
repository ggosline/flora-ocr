...
authority: L. var. gratissimum Planche 19(1, 2)
genus: Ocimum
vol: 58
pages: 81-82
...
menthe gabonaise (fr.) ; African basil, East Indian basil (angl.) ; adjumadju (mindumu) ; asèp (fang) ; désépéké, ndondowèlè, sépili (béséki) ; didudumba (masangu) ; dika. dumba (éshi ra, bavarama) ; édumbé-dumbé (bavové) ; étsèpu (ivéa) ; étsipo (mitsogo) ; ihépo (benga) ; lédumbadumba, ndjundjubèlè (banzabi) ; lévuvumba (loango) ; lidudumba (baduma, bavili) ; ndjatsi (balumbu) ; ndundubèlè (ngowé) ; ndun dumènè (galoa) ; ndunduwèlè (nkomi) ; ndunduwènè (orungu) ; ndzandza (bapunu, bavungu) ; nunduwèlè (mpongwè) ; tsèpu (ap-indji). Usage : Les feuilles sèches et réduites en poudre remplacent le poivre pour épicer les aliments. Les feuilles et les inflorescences sont utilisées pour préparer des infusions toniques et calmantes. Parfois, les feuilles sont mâchées pour soigner les rhumes ou le jus de feuilles est déposé dans le nez. Les feuilles sont utilisées contre la lèpre et pour la cicatrisation des plaies. De feuilles séchées sont brûlées pour désinfecter les chambres mortuaires ou éloigner les moustiques

voir sous var. gratissimum . Usage : voir sous var. gratissimum . B : Kumar et al. (2019), Morales (2011), Paton et al. (2013), Raponda-Walker & Sillans i B liographie (1961), Vieira et al. (2001)
