---
type: species
name: Solanum scabrum
authority: Mill. Planche 41
genus: Solanum
family: Solanaceae
vol: 55
pages: 128-130
...
**Genus**: [[Solanum]]
**Family**: [[Solanaceae]]
**Protologue**: Gard. Dict. , éd. 8 : n o 6 (1768)
...
morelle noire, morelle scabre (fr.) ; African nightshade, black nightshade, garden huckleberry (angl.) ; iloki (mpongwè, orungu) ; munyaka (bavarama, éshira) ; ngwangala (galoa) ; nzôm (fang) ; sagari (nkomi) ; tsagaé (mitsogo) ; tsagalé (apindji) ; tsagari (balumbu, bavungu) ; tsagili (ba vové) ; tsari (bapunu, bavungu) ; tsèki (banzabi)
