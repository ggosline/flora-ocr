...
**1.** Leaf blade broadly ovate to triangular, base truncate, margin with 8 to 10 large triangular teeth on each side; entire plant covered with stinging and burning hairs, on the petioles and sometimes also the stems, these hairs borne on a multicellular protuberance reaching up to 1 mm in length → L. mooreana (Hiern) Chew

**1′.** Leaf blade elliptic to ovate, sometimes notably enlarged in the lower half, but never distinctly triangular, base cuneate, margin with 10 (and more) small teeth pointed or rounded; stinging and burning hairs absent, limited to the inflorescence or sometimes on the entire plant, but never borne on a multicellular protuberance → couplet **2**

**2.** Female pedicel laterally winged (more so in fruit) → L. alatipes Hook.f.

**2′.** Female pedicel not winged or dorsoventrally winged → couplet **3**

**3.** Perennial herb; inflorescence almost always completely unisexual, in interrupted spikes, with glomerules on a distinct axis; male inflorescence generally in the upper leaf axils of erect stems, the female in the lower leaf axils of erect stems or on creeping and subterranean stolons; style distinctly trifid at the apex (branches unequal, the longest ± 3 mm) → [[Laportea_ovalifolia\|*L. ovalifolia*]]

**3′.** Annual or briefly perennial herb; inflorescences bisexual, in a broad flattened panicle or in interrupted spikes with bisexual glomerules; style branched or simple → couplet **4**

**4.** Inflorescence in an ample, flattened panicle, triangular in outline; style simple → [[Laportea_aestuans\|*L. aestuans*]]
